...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-white to-pink-50">
      {/* Header */}
      <header className="bg-white/90 backdrop-blur-md border-b border-rose-200 sticky top-0 z-50 shadow-sm">
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <Link to="/" className="flex items-center space-x-3">
              <motion.div
                ...
                className="bg-gradient-to-r from-rose-500 to-pink-500 p-2.5 rounded-2xl shadow-lg"
              >
            ...
            <div className="hidden md:flex items-center space-x-4">
              {user ? (
                ...
                <div className="flex items-center space-x-3">
                  <Link
                    to="/login"
                    className="text-gray-600 hover:text-rose-600 font-semibold px-4 py-2 rounded-xl hover:bg-rose-50 transition-all"
                  >
                    Login
                  </Link>
                  <Link
                    to="/register"
                    className="bg-gradient-to-r from-rose-500 to-pink-500 text-white px-6 py-2.5 rounded-xl hover:shadow-lg transition-all font-semibold"
                  >
                    Register
                  </Link>
                </div>
            ...
            <button
              ...
              className="md:hidden p-2 text-gray-600 hover:text-rose-600 hover:bg-rose-50 rounded-xl transition-all"
            >
        ...
        {isMenuOpen && (
          <motion.div
            ...
            className="md:hidden bg-white border-t border-rose-200 px-4 py-4 shadow-lg"
          >
              ...
              {user ? (
                ...
                <div className="space-y-2 pt-2 border-t border-gray-200">
                  <Link
                    to="/login"
                    onClick={() => setIsMenuOpen(false)}
                    className="block px-4 py-3 text-gray-600 hover:text-rose-600 hover:bg-rose-50 rounded-xl font-medium transition-all"
                  >
                    Login
                  </Link>
                  <Link
                    to="/register"
                    onClick={() => setIsMenuOpen(false)}
                    className="block bg-gradient-to-r from-rose-500 to-pink-500 text-white px-4 py-3 rounded-xl text-center font-semibold"
                  >
                    Register
                  </Link>
                </div>
      ...
      {/* Footer */}
      <footer className="bg-white border-t border-rose-200 mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/shop" className="text-gray-600 hover:text-rose-600 transition-colors">Browse Products</Link></li>
                <li><Link to="/gift-suggester" className="text-gray-600 hover:text-rose-600 transition-colors">Gift Suggester</Link></li>
                <li><Link to="/hamper-builder" className="text-gray-600 hover:text-rose-600 transition-colors">Build Hamper</Link></li>
                <li><Link to="/register" className="text-gray-600 hover:text-rose-600 transition-colors">Become a Seller</Link></li>
              </ul>
            </div>
