              ...
              <div className="flex items-center justify-between p-6 border-b border-amber-200 bg-amber-50">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-700">{unreadCount} unread</p>
                  </div>
                </div>
                <button
                  onClick={() => setIsOpen(false)}
              ...
              {notifications.length > 0 && (
                <div className="flex items-center justify-between p-4 border-b border-amber-100">
                  <button
                    ...
                    className="flex items-center space-x-2 text-amber-600 hover:text-amber-800 text-sm font-medium"
                  >
              ...
              <div className="flex-1 overflow-y-auto">
                {notifications.length === 0 ? (
                  <div className="text-center py-16">
                    ...
                    <h3 className="text-lg font-semibold text-amber-900 mb-2">No notifications</h3>
                    <p className="text-amber-700 text-sm">You're all caught up!</p>
                  </div>
                ) : (
                        ...
                        <div className="flex items-start space-x-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {notification.type === 'order' && notification.data?.order_id && (
                              <button className="text-xs text-amber-600 hover:text-amber-800 font-medium mt-2">
                                View Order →
                              </button>
                            )}
                          </div>
